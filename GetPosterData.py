import requests
import json
from config import url_prod_kat, url_leftovers, url_get_categories
...
list_data = Product()
print(list_data.get_drink_category())
print(list_data.get_sweet_category())
print(list_data.get_products_data())
